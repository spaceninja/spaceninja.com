...
<img src="{{ 'hide-whitespace/github-whitespace.png' | imgPath }}" alt="Screenshot of the GitHub UI, showing the “hide whitespace changes” option.">
...
<img src="{{ 'hide-whitespace/gitlab-whitespace.png' | imgPath }}" alt="Screenshot of the GitLab UI, showing the “hide whitespace changes” button.">
