...
<img slot="media" webc:is="eleventy-image" :src="imgPath('books/river-of-teeth.jpg')" alt="">
...
<img slot="media" webc:is="eleventy-image" :src="imgPath('books/murderbot-all-systems-red.jpg')" alt="">
...
<img slot="media" webc:is="eleventy-image" :src="imgPath('books/voidwitch.jpg')" alt="">
